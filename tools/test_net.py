...
@torch.no_grad()
def perform_test(test_loader, model, classifier, test_meter, cfg):
	"""
	For classification:
...
def test(cfg):
	...
	if cfg.TEST.CHECKPOINT_FILE_PATH != "":
		...
		cu.load_checkpoint(last_checkpoint, 
					{'model': model,
					'classifier': classifier}, 
					cfg.NUM_GPUS > 1)
	...
	perform_test(test_loader, model, classifier, test_meter, cfg)
